...
function publicPreferences(settings: { interfaceDensity: string; editorSpellcheck: boolean; editorCodeLineNumbers: boolean; editorCompactMode: boolean; editorContentWidth: string }, autosaveDelayMs: number) {
